...
public int getVen_mobile() {
	return ven_mobile;
}
public void setVen_mobile(int ven_mobile) {
...
public Vendor(int ven_id, String ven_name, String ven_password, String ven_email, int ven_mobile, String ven_address) {
	super();
	this.ven_id = ven_id;
	this.ven_name = ven_name;
	this.ven_password = ven_password;
